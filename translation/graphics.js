...
const GRAPHIC_REPLACEMENTS=[
	...
	{type:'map', offsetTileset:0x1c94a6, nTiles:158, offsetMap:0x193c64, width:20, height:19, comment:'Static screen - Game Rules', file:'game_rules/map_game_rules_home'},
	/* to-do: turn these into maps */
	{type:'tileset', offset:0x1d4342, nTiles:15*2, comment:'Game rules 1.1 - Legend', file:'game_rules/old/game_rules_legend_page_first15'},
	{type:'tileset', offset:0x1df35d, nTiles:15*2, comment:'Game rules 1.2 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1e1f66, nTiles:15*2, comment:'Game rules 1.3 - Legend', file:'game_rules/old/game_rules_legend_page_last15'},
	{type:'tileset', offset:0x1d709a, nTiles:14*2, comment:'Game rules 2.1 - Legend', file:'game_rules/old/game_rules_legend_page_first14'},
	{type:'tileset', offset:0x1cccc2, nTiles:14*2, comment:'Game rules 2.2 - Legend'/*, file:'game_rules/old/game_rules_legend_page_last14'*/}, //glitches USER MODE screen?
	{type:'tileset', offset:0x1acd25, nTiles:15*2, comment:'Game rules 3.1 - Legend', file:'game_rules/old/game_rules_legend_page_first15'},
	{type:'tileset', offset:0x1b42fd, nTiles:15*2, comment:'Game rules 3.2 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1bd6de, nTiles:15*2, comment:'Game rules 3.3 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1c1829, nTiles:15*2, comment:'Game rules 3.4 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1cf60f, nTiles:15*2, comment:'Game rules 3.5 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1dc389, nTiles:14*2, comment:'Game rules 3.6 - Legend', file:'game_rules/old/game_rules_legend_page_last14'},
	{type:'tileset', offset:0x1e53ae, nTiles:14*2, comment:'Game rules 4.1 - Legend', file:'game_rules/old/game_rules_legend_page_first14'},
	{type:'tileset', offset:0x1d8d09, nTiles:15*2, comment:'Game rules 4.2 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1baa03, nTiles:15*2, comment:'Game rules 4.3 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1ea811, nTiles:14*2, comment:'Game rules 4.4 - Legend', file:'game_rules/old/game_rules_legend_page_last14'},
	{type:'tileset', offset:0x1eb381, nTiles:14*2, comment:'Game rules 5.1 - Legend', file:'game_rules/old/game_rules_legend_page_first14'},
	{type:'tileset', offset:0x1ec0e1, nTiles:15*2, comment:'Game rules 5.2 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1ecbf1, nTiles:15*2, comment:'Game rules 5.3 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1ed7c1, nTiles:15*2, comment:'Game rules 5.4 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1ee391, nTiles:15*2, comment:'Game rules 5.5 - Legend', file:'game_rules/old/game_rules_legend_page_middle'},
	{type:'tileset', offset:0x1ef121, nTiles:14*2, comment:'Game rules 5.6 - Legend', file:'game_rules/old/game_rules_legend_page_last14'},
];
